...
export default function CheckoutPage() {
  ...
  const handleSaveAddress = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        credentials: 'include', // ✅ Send cookies
        body: JSON.stringify(addressFormData), // ✅ REMOVED buyerId
      });
  ...
  const handleOnlinePayment = async () => {
    ...
    try {
      ...
      // Step 2: Configure and open Razorpay payment widget
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Store passcode in localStorage instead of sessionStorage
      localStorage.setItem(`order_${orderId}_passcode`, deliveryPasscode);
      setCart([]);
