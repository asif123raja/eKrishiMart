  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setApiError("An unknown error occurred while getting the quote.");
      }
    } finally {
  ...
  const submitProduct = async (formData: FormData, paymentMethod: 'online' | 'cod' | 'exempt') => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setApiError("An unknown error occurred while submitting the product.");
      }
    } finally {
      ...
      handler: async (response: any) => {
        ...
        try {
          ...
          if (error instanceof Error) {
            ...
            toast.error("An unknown payment verification error occurred.");
          }
        } finally {
          setIsSubmitting(false);
        }
            ...
            <div className="space-y-6">
              ...
              {image && (
                <div className="mt-4 flex flex-col items-center">
                  ...
                  700 mb-2">Preview</h3>
                  {/* ✅ 3. FIX: Replace <img> with the optimized <Image> component */}
                  <Image 
                    src={URL.createObjectURL(image)} 
                    alt="Preview"
                    width={192} // Corresponds to h-48 (48 * 4 = 192px)
                    height={192}
