...
//     try {
//       setLoading(true);
//       // Get the manager's EMAIL from sessionStorage (not ID)
...
//         headers: {
//           'x-user-id': managerEmail // Send email instead of ID
//         }
//       });
...
//     // ✅ CHANGE: Get 'userId' from sessionStorage
...
//     // This state update logic is fine and doesn't need to change
//     setSellers(prev => 
//       prev.map(seller => ({
//         ...seller,
