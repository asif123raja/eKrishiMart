        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          {role === "seller" && (
            <>
              ...
              <Link href="/seller/pending" className="text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Pending
              </Link>
              <button onClick={logout} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg">
                Logout
          ...
          <div className="fixed top-0 right-0 h-full w-3/4 bg-teal-800 z-50 p-6 shadow-lg">
            ...
            {role === "buyer" && (
              <>
                ...
                <Link href="/buyer/orderHistory" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Orders
                </Link>
                <Link href="/buyer/fruits" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  Fruits
                </Link>
                <Link href="/buyer/allitems" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  All Items
                </Link>
                <Link href="/buyer/helpsection" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  Help Section
                </Link>
            ...
            {role === "seller" && (
              <>
                <Link href="/seller/profile" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Profile
                </Link>
                <Link href="/seller/orders" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Orders
                </Link>
                <Link href="/seller/addproduct" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  Create New Item
                </Link>
                <Link href="/seller/products" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  Update Item
                </Link>
                <Link href="/seller/orders" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  Orders
                </Link>
                <Link href="/seller/pending" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Pending
              </Link>
                <button onClick={logout} className="w-full mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg">
                  Logout
            ...
            {role === "manager" && (
              <>
                <Link href="/manager/orders" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Buyer Orders
                </Link>
                <Link href="/manager/orders/completed" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                Completed Orders
                </Link>
                <Link href="/manager/pending" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  Seller Pending
                </Link>
                <Link href="/manager/products" className="block text-white hover:bg-teal-700 px-3 py-2 rounded-md">
                  ALL Items
                </Link>
                <button onClick={logout} className="w-full mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg">
                  Logout
