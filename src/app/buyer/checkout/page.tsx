...
//     console.log("userId from session", buyerId)
//     console.log("token this is", token);
//     if (!buyerId || !token) {
//       console.log("this is !buyerId", !buyerId)
//       router.push('/login');
...
//     // Prepare payload for COD orders
//     const payload = {
//       shippingAddress: formatAddress(selectedAddress as Address),
//       paymentMethod: 'cod'
//     };
...
// This is the recommended, more secure version of your function
